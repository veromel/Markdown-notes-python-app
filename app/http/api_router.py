...
from app.http.notes import create_note, get_note, list_notes, update_note, delete_note, check_grammar

api_router = APIRouter()

# Routers para cada funcionalidad de las notas
api_router.include_router(list_notes.router, prefix="/notes",
                          tags=["Notes"])
